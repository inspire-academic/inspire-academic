...
--
-- DIAGRAM ASSETS — PRODUCED 2026-08-21. All 17 diagrams flagged above
-- are now in place:
--   - Three genuine photographs (Q03.1 Figure 3, Q04.1 Figure 5,
--     Q04.4 Figure 6) were cropped from the rendered source PDF pages
--     at 200 DPI using poppler pdftoppm + ImageMagick (installed this
--     session — winget oschwartz10612.Poppler and ImageMagick.Q16),
--     converted to WebP, and committed under
--     assets/images/physics/pasco/aqa-8463-1h-jun24-fig0{3,5,6}.webp
--     (29.4KB / 24.7KB / 12.3KB — all well under the 80KB budget).
--     Referenced via <img src="..." alt="..."> in question_content.
--   - The remaining 14 diagrams (schematics, circuits, symbols, and
--     data graphs) were hand-authored as inline SVG, theme-aware via
--     the same base design tokens every page already loads (var(--text),
--     var(--text-muted), var(--gold), var(--blue), var(--bg-hover) —
--     PASCO has no dedicated page yet to define the lesson-local
--     --diagram-* aliases teaching-lessons/*.html use, so these
--     reference tokens.css's tokens directly). Each was rendered via
--     ImageMagick's rsvg delegate and visually verified before
--     embedding — two rendering bugs were caught this way (Q07.1's
--     first cylinder attempt had a genuinely invisible-at-low-density
--     wall; Q09.1's Figure 14 had a hidden arrowhead and overlapping
--     labels) and fixed before commit.
--   - IMPORTANT — two graphs needed a neutral (non-answer-revealing)
--     version for question_content, with the answer-marked version
--     moved to worked_solution instead: Q03.2's graph options (the
--     first draft highlighted the correct answer C in gold with a
--     check, directly inside the question) and Q05.5's Figure 9 (the
--     first draft marked the exact "~80 Ω at 20°C" reading the student
--     is supposed to determine themselves). Both question_content
--     versions now show only the plain, ungraded figure; the graded
--     versions live in worked_solution where reveal-after-attempt is
--     correct. Any future diagram embedding must apply this same
--     check — a diagram in question_content must never encode the
...
$q$Which graph shows the relationship between the resistance of a wire at constant temperature and its length? Tick one box. <svg viewBox="0 0 560 190" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-q032-title" aria-describedby="pasco-q032-desc"><title id="pasco-q032-title">Three resistance-versus-length graph options</title><desc id="pasco-q032-desc">Option A: resistance decreases in a straight line as length increases. Option B: resistance rises steeply then levels off as length increases. Option C: resistance increases in a straight line through the origin as length increases.</desc><style>.ax{stroke:var(--text-muted);stroke-width:1.5}.ln{fill:none;stroke:var(--text);stroke-width:2.5;stroke-linecap:round}.lbl{fill:var(--text-muted);font-family:sans-serif;font-size:10}.opt{fill:var(--text);font-family:sans-serif;font-size:16;font-weight:700}</style><g transform="translate(15,15)"><line x1="0" y1="110" x2="0" y2="0" class="ax"/><line x1="0" y1="110" x2="110" y2="110" class="ax"/><polyline points="6,15 104,95" class="ln"/><text x="-4" y="-4" class="lbl">Resistance</text><text x="55" y="128" class="lbl" text-anchor="middle">Length</text></g><text x="150" y="80" class="opt">A</text><rect x="150" y="60" width="22" height="22" fill="none" stroke="var(--text-muted)" stroke-width="1.5"/><g transform="translate(200,15)"><line x1="0" y1="110" x2="0" y2="0" class="ax"/><line x1="0" y1="110" x2="110" y2="110" class="ax"/><polyline points="6,105 24,30 48,14 104,12" class="ln"/><text x="-4" y="-4" class="lbl">Resistance</text><text x="55" y="128" class="lbl" text-anchor="middle">Length</text></g><text x="335" y="80" class="opt">B</text><rect x="335" y="60" width="22" height="22" fill="none" stroke="var(--text-muted)" stroke-width="1.5"/><g transform="translate(385,15)"><line x1="0" y1="110" x2="0" y2="0" class="ax"/><line x1="0" y1="110" x2="110" y2="110" class="ax"/><polyline points="6,105 104,15" class="ln"/><text x="-4" y="-4" class="lbl">Resistance</text><text x="55" y="128" class="lbl" text-anchor="middle">Length</text></g><text x="520" y="80" class="opt">C</text><rect x="520" y="60" width="22" height="22" fill="none" stroke="var(--text-muted)" stroke-width="1.5"/></svg> [1 mark]$q$,
...
<svg viewBox="0 0 560 190" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-q032-ws-title" aria-describedby="pasco-q032-ws-desc"><title id="pasco-q032-ws-title">The three graph options, with the correct answer marked</title><desc id="pasco-q032-ws-desc">Option C, the straight line through the origin, is highlighted in gold with a check as the correct answer.</desc><style>.ax{stroke:var(--text-muted);stroke-width:1.5}.ln{fill:none;stroke:var(--text);stroke-width:2.5;stroke-linecap:round}.lbl{fill:var(--text-muted);font-family:sans-serif;font-size:10}.opt{fill:var(--text);font-family:sans-serif;font-size:16;font-weight:700}.correct{stroke:var(--gold);stroke-width:2.5}</style><g transform="translate(15,15)"><line x1="0" y1="110" x2="0" y2="0" class="ax"/><line x1="0" y1="110" x2="110" y2="110" class="ax"/><polyline points="6,15 104,95" class="ln"/><text x="-4" y="-4" class="lbl">Resistance</text><text x="55" y="128" class="lbl" text-anchor="middle">Length</text></g><text x="150" y="80" class="opt">A</text><rect x="150" y="60" width="22" height="22" fill="none" stroke="var(--text-muted)" stroke-width="1.5"/><g transform="translate(200,15)"><line x1="0" y1="110" x2="0" y2="0" class="ax"/><line x1="0" y1="110" x2="110" y2="110" class="ax"/><polyline points="6,105 24,30 48,14 104,12" class="ln"/><text x="-4" y="-4" class="lbl">Resistance</text><text x="55" y="128" class="lbl" text-anchor="middle">Length</text></g><text x="335" y="80" class="opt">B</text><rect x="335" y="60" width="22" height="22" fill="none" stroke="var(--text-muted)" stroke-width="1.5"/><g transform="translate(385,15)"><line x1="0" y1="110" x2="0" y2="0" class="ax"/><line x1="0" y1="110" x2="110" y2="110" class="ax"/><polyline points="6,105 104,15" class="ln correct"/><text x="-4" y="-4" class="lbl">Resistance</text><text x="55" y="128" class="lbl" text-anchor="middle">Length</text></g><text x="520" y="80" class="opt" fill="var(--gold)">C</text><rect x="520" y="60" width="22" height="22" fill="none" stroke="var(--gold)" stroke-width="2.5"/><path d="M525 71 l5 6 l11 -14" fill="none" stroke="var(--gold)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>$q$,
'AO1', 11
FROM past_papers pp JOIN subjects s ON s.id = pp.subject_id
WHERE s.name='Physics' AND pp.exam_board='AQA' AND pp.tier='Higher' AND pp.year=2024 AND pp.series='June' AND pp.paper_number=1;
...
$q$Figure 4 shows a static electricity generator: a metal dome connected by a rubber belt to a motor, which turns the belt. <svg viewBox="0 0 320 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig4-title" aria-describedby="pasco-fig4-desc"><title id="pasco-fig4-title">Figure 4: a static electricity generator</title><desc id="pasco-fig4-desc">A metal dome sits atop a rubber belt, which loops down to a motor at its base. Arrows show the belt moving up on one side and down on the other.</desc><style>.i{stroke:var(--text);fill:none}.t{fill:var(--text);font-family:sans-serif;font-size:13}</style><circle cx="90" cy="45" r="38" class="i" stroke-width="2.5" fill="var(--bg-hover)"/><line x1="75" y1="80" x2="75" y2="185" class="i" stroke-width="3"/><line x1="105" y1="80" x2="105" y2="185" class="i" stroke-width="3"/><path d="M70 150 l-8 -8 M70 150 l8 -8" class="i" stroke-width="2.5"/><path d="M110 130 l-8 8 M110 130 l8 8" class="i" stroke-width="2.5"/><ellipse cx="90" cy="205" rx="35" ry="24" class="i" stroke-width="2.5" fill="var(--bg-hover)"/><line x1="145" y1="45" x2="215" y2="45" class="i" stroke-width="1.5"/><text x="220" y="49" class="t">Metal dome</text><line x1="120" y1="115" x2="215" y2="105" class="i" stroke-width="1.5"/><text x="220" y="109" class="t">Rubber belt</text><text x="130" y="150" class="t" font-size="12">Movement</text><text x="130" y="164" class="t" font-size="12">of belt</text><line x1="120" y1="205" x2="215" y2="205" class="i" stroke-width="1.5"/><text x="220" y="209" class="t">Motor</text></svg> The rubber belt is turned by a motor. As the rubber belt moves, charge is transferred from the rubber belt to the metal dome. Figure 5 shows a student touching the metal dome of the static electricity generator. The dome is negatively charged. <img src="/assets/images/physics/pasco/aqa-8463-1h-jun24-fig05.webp" alt="Figure 5: a student touching the metal dome of the static electricity generator, with her hair standing on end."> Explain why the student's hair stands up on end. [3 marks]$q$,
...
$q$Figure 8 shows part of a different circuit used to monitor the temperature inside the vending machine: a 12 V supply connected to a 400 Ω fixed resistor in series with a thermistor, with a voltmeter connected across the thermistor. <svg viewBox="0 0 300 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig8-title" aria-describedby="pasco-fig8-desc"><title id="pasco-fig8-title">Figure 8: thermistor temperature-monitoring circuit (symbol not yet drawn)</title><desc id="pasco-fig8-desc">A 12 volt supply connected in series to a 400 ohm fixed resistor and an empty box where the thermistor symbol should be drawn, with a voltmeter connected across it.</desc><style>.i{stroke:var(--text);fill:none}.t{fill:var(--text);font-family:sans-serif;font-size:13}</style><line x1="30" y1="20" x2="170" y2="20" class="i" stroke-width="2"/><line x1="30" y1="20" x2="30" y2="180" class="i" stroke-width="2"/><line x1="30" y1="180" x2="170" y2="180" class="i" stroke-width="2"/><line x1="24" y1="85" x2="36" y2="85" class="i" stroke-width="3"/><line x1="21" y1="100" x2="39" y2="100" class="i" stroke-width="1.5"/><line x1="24" y1="115" x2="36" y2="115" class="i" stroke-width="3"/><line x1="21" y1="130" x2="39" y2="130" class="i" stroke-width="1.5"/><text x="46" y="112" class="t">12 V</text><line x1="170" y1="20" x2="170" y2="50" class="i" stroke-width="2"/><rect x="155" y="50" width="30" height="40" class="i" stroke-width="2"/><text x="192" y="75" class="t">400 Ω</text><line x1="170" y1="90" x2="170" y2="105" class="i" stroke-width="2"/><rect x="155" y="105" width="30" height="40" class="i" stroke-width="2" stroke-dasharray="4 3"/><text x="152" y="163" class="t" font-size="11" text-anchor="end">Thermistor</text><line x1="170" y1="145" x2="170" y2="180" class="i" stroke-width="2"/><line x1="170" y1="90" x2="255" y2="90" class="i" stroke-width="2"/><line x1="170" y1="180" x2="255" y2="180" class="i" stroke-width="2"/><line x1="255" y1="90" x2="255" y2="112" class="i" stroke-width="2"/><line x1="255" y1="158" x2="255" y2="180" class="i" stroke-width="2"/><circle cx="255" cy="135" r="23" class="i" stroke-width="2"/><text x="255" y="141" class="t" text-anchor="middle" font-size="16">V</text></svg> The circuit symbol for a thermistor has not been included. Draw the circuit symbol for a thermistor in the box below. [1 mark]$q$,
...
$q$<svg viewBox="0 0 90 44" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-q054-symbol-title"><title id="pasco-q054-symbol-title">Thermistor circuit symbol</title><style>.i{stroke:var(--text)}.t{fill:var(--text);font-family:sans-serif}</style><line x1="0" y1="22" x2="10" y2="22" class="i" stroke-width="2"/><rect x="10" y="14" width="40" height="16" fill="none" class="i" stroke-width="2"/><line x1="50" y1="22" x2="60" y2="22" class="i" stroke-width="2"/><line x1="6" y1="38" x2="54" y2="6" class="i" stroke-width="2"/><text x="64" y="27" font-size="15" class="t">t°</text></svg> The thermistor symbol follows the same pattern as other GCSE circuit component symbols that respond to an external condition: a rectangle (the resistor base symbol) plus a diagonal line labelled with what it responds to — "t°" for temperature (thermistor), the direct counterpart to the light-arrows used for an LDR. Mixing up this pair of symbols (drawing an LDR's light arrows instead of "t°") is the single most common error on this question.$q$,
'AO1', 21
FROM past_papers pp JOIN subjects s ON s.id = pp.subject_id
WHERE s.name='Physics' AND pp.exam_board='AQA' AND pp.tier='Higher' AND pp.year=2024 AND pp.series='June' AND pp.paper_number=1;
...
$q$Figure 9 shows how the resistance of the thermistor varies with temperature. <svg viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig9-title" aria-describedby="pasco-fig9-desc"><title id="pasco-fig9-title">Figure 9: thermistor resistance versus temperature</title><desc id="pasco-fig9-desc">A curve showing the thermistor's resistance falling from about 600 ohms at 10 degrees Celsius to about 20 ohms at 30 degrees Celsius.</desc><style>.ax{stroke:var(--text-muted);stroke-width:1.5}.grid{stroke:var(--text-muted);stroke-width:0.75;opacity:0.3}.ln{fill:none;stroke:var(--text);stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}.lbl{fill:var(--text-muted);font-family:sans-serif;font-size:11}.axlbl{fill:var(--text-muted);font-family:sans-serif;font-size:12}</style><g transform="translate(60,20)"><line x1="0" y1="220" x2="300" y2="220" class="grid"/><line x1="0" y1="183" x2="300" y2="183" class="grid"/><line x1="0" y1="147" x2="300" y2="147" class="grid"/><line x1="0" y1="110" x2="300" y2="110" class="grid"/><line x1="0" y1="73" x2="300" y2="73" class="grid"/><line x1="0" y1="37" x2="300" y2="37" class="grid"/><line x1="0" y1="0" x2="300" y2="0" class="grid"/><text x="-10" y="224" class="lbl" text-anchor="end">0</text><text x="-10" y="187" class="lbl" text-anchor="end">100</text><text x="-10" y="151" class="lbl" text-anchor="end">200</text><text x="-10" y="114" class="lbl" text-anchor="end">300</text><text x="-10" y="77" class="lbl" text-anchor="end">400</text><text x="-10" y="41" class="lbl" text-anchor="end">500</text><text x="-10" y="4" class="lbl" text-anchor="end">600</text><text x="0" y="238" class="lbl" text-anchor="middle">0</text><text x="50" y="238" class="lbl" text-anchor="middle">5</text><text x="100" y="238" class="lbl" text-anchor="middle">10</text><text x="150" y="238" class="lbl" text-anchor="middle">15</text><text x="200" y="238" class="lbl" text-anchor="middle">20</text><text x="250" y="238" class="lbl" text-anchor="middle">25</text><text x="300" y="238" class="lbl" text-anchor="middle">30</text><line x1="0" y1="220" x2="0" y2="0" class="ax"/><line x1="0" y1="220" x2="300" y2="220" class="ax"/><polyline points="100,0 120,66 140,117 160,150 180,172 200,191 220,199 250,206 300,213" class="ln"/><text x="150" y="-6" class="axlbl" text-anchor="middle">Resistance in Ω vs Temperature in °C</text></g></svg> The cooling system inside the vending machine turns on when the temperature of the thermistor is above 20°C. Determine the potential difference across the thermistor when the temperature is 20°C. Use the Physics Equations Sheet. [5 marks] Potential difference = ___ V$q$,
...
<svg viewBox="0 0 420 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig9-ws-title" aria-describedby="pasco-fig9-ws-desc"><title id="pasco-fig9-ws-title">Figure 9 with the 20°C reading marked</title><desc id="pasco-fig9-ws-desc">The same resistance-versus-temperature curve, with the reading of approximately 80 ohms at 20 degrees Celsius marked in gold.</desc><style>.ax{stroke:var(--text-muted);stroke-width:1.5}.grid{stroke:var(--text-muted);stroke-width:0.75;opacity:0.3}.ln{fill:none;stroke:var(--text);stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}.lbl{fill:var(--text-muted);font-family:sans-serif;font-size:11}.axlbl{fill:var(--text-muted);font-family:sans-serif;font-size:12}</style><g transform="translate(60,20)"><line x1="0" y1="220" x2="300" y2="220" class="grid"/><line x1="0" y1="183" x2="300" y2="183" class="grid"/><line x1="0" y1="147" x2="300" y2="147" class="grid"/><line x1="0" y1="110" x2="300" y2="110" class="grid"/><line x1="0" y1="73" x2="300" y2="73" class="grid"/><line x1="0" y1="37" x2="300" y2="37" class="grid"/><line x1="0" y1="0" x2="300" y2="0" class="grid"/><text x="-10" y="224" class="lbl" text-anchor="end">0</text><text x="-10" y="187" class="lbl" text-anchor="end">100</text><text x="-10" y="151" class="lbl" text-anchor="end">200</text><text x="-10" y="114" class="lbl" text-anchor="end">300</text><text x="-10" y="77" class="lbl" text-anchor="end">400</text><text x="-10" y="41" class="lbl" text-anchor="end">500</text><text x="-10" y="4" class="lbl" text-anchor="end">600</text><text x="0" y="238" class="lbl" text-anchor="middle">0</text><text x="50" y="238" class="lbl" text-anchor="middle">5</text><text x="100" y="238" class="lbl" text-anchor="middle">10</text><text x="150" y="238" class="lbl" text-anchor="middle">15</text><text x="200" y="238" class="lbl" text-anchor="middle">20</text><text x="250" y="238" class="lbl" text-anchor="middle">25</text><text x="300" y="238" class="lbl" text-anchor="middle">30</text><line x1="0" y1="220" x2="0" y2="0" class="ax"/><line x1="0" y1="220" x2="300" y2="220" class="ax"/><polyline points="100,0 120,66 140,117 160,150 180,172 200,191 220,199 250,206 300,213" class="ln"/><circle cx="200" cy="191" r="4" fill="var(--gold)"/><text x="212" y="188" font-family="sans-serif" font-size="11" fill="var(--gold)">~80 Ω at 20°C</text><text x="150" y="-6" class="axlbl" text-anchor="middle">Resistance in Ω vs Temperature in °C</text></g></svg>$q$,
'AO2', 22
FROM past_papers pp JOIN subjects s ON s.id = pp.subject_id
WHERE s.name='Physics' AND pp.exam_board='AQA' AND pp.tier='Higher' AND pp.year=2024 AND pp.series='June' AND pp.paper_number=1;
...
$q$In a ride at a theme park, a person is strapped into a pod attached to two stretched bungee cords, which behave like springs. <svg viewBox="0 0 420 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig10-title" aria-describedby="pasco-fig10-desc"><title id="pasco-fig10-title">Figure 10: a bungee ride, before and after release</title><desc id="pasco-fig10-desc">Before release, the pod is held down near the ground by two taut bungee cords stretched from tall support towers. After release, the pod has sprung upward, with the cords now loose and wavy.</desc><style>.i{stroke:var(--text);fill:none}.t{fill:var(--text-muted);font-family:sans-serif;font-size:12}.tt{fill:var(--text-muted);font-family:sans-serif;font-size:13;font-weight:700}.tower{fill:var(--bg-hover);stroke:var(--text)}</style><text x="90" y="14" class="tt" text-anchor="middle">Before release</text><g transform="translate(10,24)"><polygon points="20,10 5,170 35,170" class="tower" stroke-width="2"/><polygon points="160,10 145,170 175,170" class="tower" stroke-width="2"/><line x1="20" y1="10" x2="90" y2="168" class="i" stroke-width="2"/><line x1="160" y1="10" x2="90" y2="168" class="i" stroke-width="2"/><circle cx="90" cy="172" r="9" class="i" stroke-width="2" fill="var(--bg-card)"/></g><text x="310" y="14" class="tt" text-anchor="middle">After release</text><g transform="translate(230,24)"><polygon points="20,10 5,170 35,170" class="tower" stroke-width="2"/><polygon points="160,10 145,170 175,170" class="tower" stroke-width="2"/><path d="M20 10 Q55 55 65 60 T90 90" class="i" stroke-width="2"/><path d="M160 10 Q125 55 115 60 T90 90" class="i" stroke-width="2"/><circle cx="90" cy="94" r="9" class="i" stroke-width="2" fill="var(--bg-card)"/></g><text x="90" y="220" class="t" text-anchor="middle">Support tower</text><text x="90" y="234" class="t" text-anchor="middle">Stretched bungee cords · Pod</text></svg> Which energy store increases as the bungee cords are stretched? [1 mark]$q$,
...
$q$Figure 11 shows a measuring cylinder containing some water, which a student used to measure the volume of a metal ring. <svg viewBox="0 0 220 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig11-title" aria-describedby="pasco-fig11-desc"><title id="pasco-fig11-title">Figure 11: a measuring cylinder containing water</title><desc id="pasco-fig11-desc">A 0 to 10 cubic centimetre measuring cylinder scale, with water filled to the 5.0 cubic centimetre mark.</desc><style>.i{stroke:var(--text);fill:none}.t{fill:var(--text-muted);font-family:sans-serif;font-size:11}.water{fill:var(--bg-hover);stroke:none}</style><text x="60" y="16" class="t" font-size="13">cm³</text><path d="M60 122.5 L60 220 Q60 232 72 232 L98 232 Q110 232 110 220 L110 122.5 Z" class="water"/><path d="M60 25 L60 220 Q60 232 72 232 L98 232 Q110 232 110 220 L110 25" class="i" stroke-width="2"/><g stroke="var(--text)" stroke-width="1.5"><line x1="110" y1="220" x2="123" y2="220"/><text x="129" y="224" class="t">0</text><line x1="110" y1="181" x2="123" y2="181"/><text x="129" y="185" class="t">2</text><line x1="110" y1="142" x2="123" y2="142"/><text x="129" y="146" class="t">4</text><line x1="110" y1="103" x2="123" y2="103"/><text x="129" y="107" class="t">6</text><line x1="110" y1="64" x2="123" y2="64"/><text x="129" y="68" class="t">8</text><line x1="110" y1="25" x2="123" y2="25"/><text x="129" y="29" class="t">10</text></g><line x1="0" y1="122.5" x2="60" y2="122.5" class="i" stroke-width="1.5"/><text x="0" y="140" class="t" text-anchor="start">Water</text></svg> When measuring the volume, the student's eye was in line with the level of the water. Which type of error would have been caused if the student's eye was not in line with the level of the water? Tick one box: Random error / Systematic error / Zero error. [1 mark]$q$,
...
$q$A student investigated how the pressure in a fixed mass of air varies with the volume of the air. Figure 12 shows the equipment used: a syringe connected to a pressure gauge, with a plunger that can be pushed in to reduce the volume of trapped air. <svg viewBox="0 0 340 180" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig12-title" aria-describedby="pasco-fig12-desc"><title id="pasco-fig12-title">Figure 12: a syringe connected to a pressure gauge</title><desc id="pasco-fig12-desc">A pressure gauge with a dial and needle is connected by a tube to a syringe barrel with graduated markings and a plunger that can push into it.</desc><style>.i{stroke:var(--text);fill:none}.t{fill:var(--text);font-family:sans-serif;font-size:12}.fill{fill:var(--bg-hover);stroke:var(--text)}</style><circle cx="55" cy="70" r="42" class="fill" stroke-width="2.5"/><circle cx="55" cy="70" r="4" fill="var(--text)"/><line x1="55" y1="70" x2="75" y2="48" stroke="var(--text)" stroke-width="2"/><text x="55" y="120" class="t" text-anchor="middle">Pressure gauge</text><path d="M97 70 Q140 30 175 65" class="i" stroke-width="4"/><rect x="175" y="45" width="120" height="40" class="fill" stroke-width="2.5"/><line x1="200" y1="45" x2="200" y2="85" class="i" stroke-width="1"/><line x1="225" y1="45" x2="225" y2="85" class="i" stroke-width="1"/><line x1="250" y1="45" x2="250" y2="85" class="i" stroke-width="1"/><line x1="275" y1="45" x2="275" y2="85" class="i" stroke-width="1"/><text x="235" y="105" class="t" text-anchor="middle">Syringe</text><rect x="295" y="58" width="16" height="14" class="fill" stroke-width="2"/><line x1="311" y1="65" x2="335" y2="65" class="i" stroke-width="3"/><text x="295" y="30" class="t" text-anchor="end">Plunger</text><line x1="315" y1="60" x2="298" y2="34" class="i" stroke-width="1"/></svg> When the plunger was pushed slowly into the syringe, the pressure in the syringe increased. The temperature of the air remained constant. Explain why the pressure increased. [3 marks]$q$,
...
$q$A fire piston is a special type of syringe that can be used to start fires. Figure 13 shows a fire piston: a plunger, piston, air chamber, and a small piece of cotton wool at the base. <svg viewBox="-15 0 315 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig13-title" aria-describedby="pasco-fig13-desc"><title id="pasco-fig13-title">Figure 13: a fire piston</title><desc id="pasco-fig13-desc">A plunger rod with a T-handle sits above a piston housing, which sits above a sealed air chamber containing a small piece of cotton wool at its base.</desc><style>.i{stroke:var(--text);fill:none}.t{fill:var(--text);font-family:sans-serif;font-size:12}.fill{fill:var(--bg-hover);stroke:var(--text)}</style><rect x="115" y="10" width="30" height="10" rx="4" class="fill" stroke-width="2"/><line x1="130" y1="20" x2="130" y2="75" class="i" stroke-width="4"/><rect x="112" y="75" width="36" height="30" class="fill" stroke-width="2"/><rect x="120" y="105" width="20" height="10" class="fill" stroke-width="2"/><rect x="105" y="115" width="50" height="90" class="i" stroke-width="2.5"/><circle cx="130" cy="200" r="6" fill="var(--border-strong)" stroke="var(--text)" stroke-width="1"/><path d="M90 205 L170 205 L150 230 L110 230 Z" class="fill" stroke-width="2.5"/><line x1="60" y1="15" x2="112" y2="15" class="i" stroke-width="1"/><text x="55" y="19" class="t" text-anchor="end">Plunger</text><line x1="60" y1="90" x2="108" y2="90" class="i" stroke-width="1"/><text x="55" y="94" class="t" text-anchor="end">Piston</text><line x1="60" y1="150" x2="103" y2="150" class="i" stroke-width="1"/><text x="55" y="154" class="t" text-anchor="end">Air</text><line x1="60" y1="200" x2="122" y2="200" class="i" stroke-width="1"/><text x="55" y="204" class="t" text-anchor="end">Cotton wool</text></svg> The plunger is pushed quickly downwards and compresses the air. When the air is compressed quickly, the temperature of the air increases. How does an increase in temperature affect the air particles inside the piston? Tick one box: The mean kinetic energy of the particles increases. / The mean potential energy of the particles increases. / The mean separation of the particles increases. [1 mark]$q$,
...
$q$A teacher investigated the radiation emitted by two different radioactive sources, A and B. <svg viewBox="0 0 380 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig14-title" aria-describedby="pasco-fig14-desc"><title id="pasco-fig14-title">Figure 14: a radiation detector positioned near a radioactive source</title><desc id="pasco-fig14-desc">A detector on a stand is connected by a cable to a counter box, positioned a measured distance away from a radioactive source on a separate stand.</desc><style>.i{stroke:var(--text);fill:none}.t{fill:var(--text);font-family:sans-serif;font-size:12}.fill{fill:var(--bg-hover);stroke:var(--text)}</style><rect x="10" y="120" width="90" height="55" class="fill" stroke-width="2"/><rect x="20" y="132" width="55" height="20" fill="var(--bg-card)" stroke="var(--text)" stroke-width="1.5"/><text x="47" y="147" class="t" text-anchor="middle" font-size="13">241</text><text x="55" y="192" class="t" text-anchor="middle">Counter</text><path d="M75 120 Q90 90 130 90" class="i" stroke-width="2.5"/><rect x="118" y="78" width="45" height="24" rx="6" class="fill" stroke-width="2"/><line x1="140" y1="102" x2="140" y2="165" class="i" stroke-width="3"/><rect x="115" y="165" width="50" height="8" class="i" stroke-width="2"/><text x="140" y="65" class="t" text-anchor="middle">Detector</text><line x1="172" y1="115" x2="238" y2="115" class="i" stroke-width="1.5"/><path d="M172 115 l9 -5 M172 115 l9 5 M238 115 l-9 -5 M238 115 l-9 5" class="i" stroke-width="1.5"/><text x="204" y="130" class="t" text-anchor="middle">Distance</text><line x1="248" y1="102" x2="248" y2="165" class="i" stroke-width="3"/><rect x="223" y="165" width="50" height="8" class="i" stroke-width="2"/><circle cx="248" cy="90" r="12" fill="var(--bg-hover)" stroke="var(--text)" stroke-width="2"/><text x="248" y="65" class="t" text-anchor="middle">Radioactive</text><text x="248" y="78" class="t" text-anchor="middle">source</text></svg> The teacher measured the count rate at different distances for each radioactive source. Figure 15 shows the results: a graph of count rate (counts per minute, 0-1500) against distance (0-10+ cm), with Source A (dashed line) falling steeply from ~350 at 1cm to background level (~20) by about 3-4cm and staying flat, and Source B (solid line) falling more gradually from ~1460 at 1cm to still ~100 at 10cm. <svg viewBox="0 0 460 335" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig15-title" aria-describedby="pasco-fig15-desc"><title id="pasco-fig15-title">Figure 15: count rate versus distance for Source A and Source B</title><desc id="pasco-fig15-desc">Source A's count rate falls from about 350 counts per minute at 1cm to background level, about 20 counts per minute, by roughly 3cm, then stays flat. Source B's count rate falls more gradually from about 1460 counts per minute at 1cm to still about 100 counts per minute at 10cm.</desc><style>.ax{stroke:var(--text-muted);stroke-width:1.5}.grid{stroke:var(--text-muted);stroke-width:0.75;opacity:0.3}.lnA{fill:none;stroke:var(--text);stroke-width:2.25;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:6 4}.lnB{fill:none;stroke:var(--blue);stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}.lbl{fill:var(--text-muted);font-family:sans-serif;font-size:10.5}.axlbl{fill:var(--text-muted);font-family:sans-serif;font-size:12}</style><g transform="translate(70,30)"><line x1="0" y1="0" x2="330" y2="0" class="grid"/><line x1="0" y1="43" x2="330" y2="43" class="grid"/><line x1="0" y1="87" x2="330" y2="87" class="grid"/><line x1="0" y1="130" x2="330" y2="130" class="grid"/><line x1="0" y1="173" x2="330" y2="173" class="grid"/><line x1="0" y1="217" x2="330" y2="217" class="grid"/><line x1="0" y1="260" x2="330" y2="260" class="grid"/><text x="-10" y="4" class="lbl" text-anchor="end">1500</text><text x="-10" y="47" class="lbl" text-anchor="end">1250</text><text x="-10" y="91" class="lbl" text-anchor="end">1000</text><text x="-10" y="134" class="lbl" text-anchor="end">750</text><text x="-10" y="177" class="lbl" text-anchor="end">500</text><text x="-10" y="221" class="lbl" text-anchor="end">250</text><text x="-10" y="264" class="lbl" text-anchor="end">0</text><text x="0" y="278" class="lbl" text-anchor="middle">0</text><text x="60" y="278" class="lbl" text-anchor="middle">2</text><text x="120" y="278" class="lbl" text-anchor="middle">4</text><text x="180" y="278" class="lbl" text-anchor="middle">6</text><text x="240" y="278" class="lbl" text-anchor="middle">8</text><text x="300" y="278" class="lbl" text-anchor="middle">10</text><line x1="0" y1="260" x2="0" y2="0" class="ax"/><line x1="0" y1="260" x2="330" y2="260" class="ax"/><text x="-55" y="-14" class="axlbl">Count rate / counts per minute</text><text x="165" y="296" class="axlbl" text-anchor="middle">Distance in centimetres</text><polyline points="30,7 60,87 90,139 120,170 150,191 180,205 210,215 240,224 270,232 300,243" class="lnB"/><polyline points="30,199 60,239 90,255 105,257 330,257" class="lnA"/></g><g transform="translate(380,50)"><text x="0" y="0" class="axlbl" font-weight="700">Key</text><line x1="0" y1="14" x2="24" y2="14" class="lnA"/><text x="30" y="18" class="lbl">Source A</text><line x1="0" y1="32" x2="24" y2="32" class="lnB"/><text x="30" y="36" class="lbl">Source B</text></g></svg> Explain how Figure 15 shows that Source A only emits alpha radiation. [3 marks]$q$,
...
$q$Figure 16 shows how the number of atoms of a radioactive element in a sample varied with time: a curve falling from 6×10²³ atoms at t=0 to about 1.5×10²³ atoms at t=540s, reading approximately 2.9×10²³ at t=300s. <svg viewBox="0 0 440 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig16-title" aria-describedby="pasco-fig16-desc"><title id="pasco-fig16-title">Figure 16: number of atoms versus time for a radioactive sample</title><desc id="pasco-fig16-desc">A decay curve showing the number of atoms, in units of times ten to the twenty-three, falling from 6 at time zero to about 1.5 at 540 seconds, reading approximately 2.9 at 300 seconds.</desc><style>.ax{stroke:var(--text-muted);stroke-width:1.5}.grid{stroke:var(--text-muted);stroke-width:0.75;opacity:0.3}.ln{fill:none;stroke:var(--text);stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}.lbl{fill:var(--text-muted);font-family:sans-serif;font-size:10.5}.axlbl{fill:var(--text-muted);font-family:sans-serif;font-size:12}</style><g transform="translate(75,20)"><line x1="0" y1="0" x2="350" y2="0" class="grid"/><line x1="0" y1="40" x2="350" y2="40" class="grid"/><line x1="0" y1="80" x2="350" y2="80" class="grid"/><line x1="0" y1="120" x2="350" y2="120" class="grid"/><line x1="0" y1="160" x2="350" y2="160" class="grid"/><line x1="0" y1="200" x2="350" y2="200" class="grid"/><line x1="0" y1="240" x2="350" y2="240" class="grid"/><text x="-10" y="4" class="lbl" text-anchor="end">6</text><text x="-10" y="44" class="lbl" text-anchor="end">5</text><text x="-10" y="84" class="lbl" text-anchor="end">4</text><text x="-10" y="124" class="lbl" text-anchor="end">3</text><text x="-10" y="164" class="lbl" text-anchor="end">2</text><text x="-10" y="204" class="lbl" text-anchor="end">1</text><text x="-10" y="244" class="lbl" text-anchor="end">0</text><text x="0" y="258" class="lbl" text-anchor="middle">0</text><text x="58" y="258" class="lbl" text-anchor="middle">100</text><text x="117" y="258" class="lbl" text-anchor="middle">200</text><text x="175" y="258" class="lbl" text-anchor="middle">300</text><text x="233" y="258" class="lbl" text-anchor="middle">400</text><text x="292" y="258" class="lbl" text-anchor="middle">500</text><text x="350" y="258" class="lbl" text-anchor="middle">600</text><line x1="0" y1="240" x2="0" y2="0" class="ax"/><line x1="0" y1="240" x2="350" y2="240" class="ax"/><text x="-60" y="-6" class="axlbl">Number of atoms ×10²³</text><text x="175" y="278" class="axlbl" text-anchor="middle">Time in seconds</text><polyline points="0,0 29,28 58,56 88,78 117,96 146,112 175,124 204,140 233,152 263,160 292,172 315,180" class="ln"/><circle cx="175" cy="124" r="4" fill="var(--gold)"/><text x="185" y="120" font-family="sans-serif" font-size="11" fill="var(--gold)">t = 300 s</text></g></svg> Activity is the rate at which a source of unstable nuclei decays. Determine the activity of the radioactive sample at 300 seconds. Give the unit. [4 marks] Activity = ___ Unit = ___$q$,
...
$q$Figure 17 shows a fuse: a glass tube with metal end caps and a thin fuse wire running through it. <svg viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-fig17-title" aria-describedby="pasco-fig17-desc"><title id="pasco-fig17-title">Figure 17: a fuse</title><desc id="pasco-fig17-desc">A cylindrical glass tube with a metal end cap at each end and a thin fuse wire running along its length inside.</desc><style>.i{stroke:var(--text);fill:none}.t{fill:var(--text);font-family:sans-serif;font-size:12}.cap{fill:var(--bg-hover);stroke:var(--text)}.glass{fill:var(--bg-hover);stroke:var(--text)}</style><rect x="55" y="35" width="20" height="40" rx="4" class="cap" stroke-width="2"/><rect x="75" y="40" width="110" height="30" class="glass" stroke-width="2"/><rect x="185" y="42" width="20" height="26" rx="4" class="cap" stroke-width="2"/><line x1="80" y1="65" x2="180" y2="45" class="i" stroke-width="2"/><line x1="60" y1="90" x2="90" y2="70" class="i" stroke-width="1.5"/><text x="30" y="105" class="t">Fuse wire</text></svg> Draw the circuit symbol for a fuse in the box below. [1 mark]$q$,
...
$q$<svg viewBox="0 0 100 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pasco-q102-symbol-title"><title id="pasco-q102-symbol-title">Fuse circuit symbol</title><line x1="0" y1="20" x2="25" y2="20" stroke="var(--text)" stroke-width="2"/><rect x="25" y="8" width="50" height="24" fill="none" stroke="var(--text)" stroke-width="2"/><line x1="75" y1="20" x2="100" y2="20" stroke="var(--text)" stroke-width="2"/></svg> Component circuit symbols in this spec generally build from a small set of base shapes — the fuse's rectangle is the simplest of the group, since it has no extra markings. Don't confuse it with the thermistor or LDR symbols, which are the same rectangle but with an added diagonal line and label.$q$,
'AO1', 40
FROM past_papers pp JOIN subjects s ON s.id = pp.subject_id
WHERE s.name='Physics' AND pp.exam_board='AQA' AND pp.tier='Higher' AND pp.year=2024 AND pp.series='June' AND pp.paper_number=1;
