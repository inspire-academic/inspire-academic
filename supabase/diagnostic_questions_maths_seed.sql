...
('Mathematics','AQA','GCSE','Higher','Number — basics and operations','Place value','TO_BE_VERIFIED',1,
 'What is the value of the digit 6 in the number 26,451?','6000','60','600',
 '6','Not sure', 'a',
...
('Mathematics','AQA','GCSE','Higher','Number — basics and operations','Prime factor decomposition','TO_BE_VERIFIED',2,
 'What is 60 written as a product of its prime factors?','2 × 30','2 × 3 × 10','4 × 15',
 '2² × 3 × 5','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Fractions, decimals and percentages','Converting FDP','TO_BE_VERIFIED',1,
 'Write 0.35 as a fraction in its simplest form.','7/10','35/100',
 '7/20','3.5/10','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Fractions, decimals and percentages','Operations with fractions','TO_BE_VERIFIED',2,
 'Work out 2/3 + 1/4. Give your answer as a single fraction.','3/12','3/7','8/12',
 '11/12','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Fractions, decimals and percentages','Reverse percentage','TO_BE_VERIFIED',3,
 'A sale reduces a price by 20%, giving a sale price of £48. What was the original price?','£38.40','£57.60',
 '£60','£68','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Ratio, proportion and rates of change','Simplifying ratios','TO_BE_VERIFIED',1,
 'Simplify the ratio 24:36 to its simplest form.','4:6',
 '2:3','12:18','1:2','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Ratio, proportion and rates of change','Direct and inverse proportion','TO_BE_VERIFIED',3,
 'y is directly proportional to x. When x=4, y=20. What is y when x=7?','140','23','28',
 '35','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Ratio, proportion and rates of change','Speed, distance, time','TO_BE_VERIFIED',1,
 'A car travels 150 km in 2.5 hours. What is its average speed?','152.5 km/h','375 km/h','75 km/h',
 '60 km/h','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Powers, roots and standard form','Standard form','TO_BE_VERIFIED',2,
 'Write 45,000 in standard form.','45×10³',
 '4.5×10⁴','0.45×10⁵','4.5×10⁵','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Powers, roots and standard form','Surds (Higher)','TO_BE_VERIFIED',3,
 'Simplify √50 into the form a√b, where b has no square-number factors.','2√5',
 '5√2','10√5','25√2','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Powers, roots and standard form','Fractional indices (Higher)','TO_BE_VERIFIED',3,
 'Work out the value of 8^(1/3).','24','2.67','4',
 '2','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Algebra — expressions','Simplifying','TO_BE_VERIFIED',1,
 'Simplify: 5a + 3b − 2a + 7b','8ab','8a+10b','3a+4b',
 '3a+10b','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Algebra — expressions','Expanding brackets','TO_BE_VERIFIED',1,
 'Expand: 3(2x − 5)','−6x+15','6x−5','2x−15',
 '6x−15','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Algebra — expressions','Factorising','TO_BE_VERIFIED',2,
 'Factorise fully: 6x² + 9x','3x(2x+9)','x(6x+9)','3(2x²+3x)',
 '3x(2x+3)','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Algebra — expressions','Difference of two squares (Higher)','TO_BE_VERIFIED',2,
 'Factorise: x² − 49','(x−7)²','(x−49)(x+1)',
 '(x−7)(x+7)','Cannot be factorised','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Equations and inequalities','Simultaneous equations','TO_BE_VERIFIED',2,
 'Solve the simultaneous equations: x + y = 10 and x − y = 4. What is the value of x?','x=5','x=3',
 'x=7','x=14','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Equations and inequalities','Inequalities','TO_BE_VERIFIED',2,
 'Solve the inequality: 3x − 4 > 11','x>2.33',
 'x>5','x<5','x>45','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Sequences','nth term arithmetic','TO_BE_VERIFIED',2,
 'Find the nth term of the sequence: 5, 8, 11, 14, ...','3n−2','3n+5','n+3',
 '3n+2','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Sequences','Quadratic sequences (Higher)','TO_BE_VERIFIED',3,
 'Find the nth term of the quadratic sequence: 3, 8, 15, 24, 35, ...','2n²+n','n²+2',
 'n²+2n','n²+3n−1','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Sequences','Geometric sequences','TO_BE_VERIFIED',2,
 'Find the next term in the geometric sequence: 2, 6, 18, 54, ...','216','108',
 '162','57','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Graphs','Straight line graphs — y=mx+c','TO_BE_VERIFIED',1,
 'What is the gradient of the line y = 4x − 7?','−7',
 '4','−7/4','1/4','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Graphs','Cubic and reciprocal (Higher)','TO_BE_VERIFIED',2,
 'What happens to y as x increases, in the reciprocal graph y = 1/x, for positive values of x?','y decreases and eventually reaches 0','y increases towards infinity','y stays constant',
 'y decreases towards 0 but never reaches it','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Graphs','Transformations (Higher)','TO_BE_VERIFIED',2,
 'The graph of y = f(x) is transformed to y = f(x) + 3. What effect does this have on the graph?','Stretches the graph vertically by scale factor 3','Translates the graph left by 3 units',
 'Translates the graph up by 3 units','Translates the graph down by 3 units','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Algebra — Higher only','Completing the square','TO_BE_VERIFIED',3,
 'Write x² + 6x + 5 in the form (x + a)² + b.','(x+3)²+5',
 '(x+3)²−4','(x+6)²−31','(x+3)²+9','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Algebra — Higher only','Quadratic formula','TO_BE_VERIFIED',3,
 'Use the quadratic formula to solve x² − 5x + 6 = 0. What are the solutions?','x=−2 and x=−3',
 'x=2 and x=3','x=5 and x=6','x=1 and x=6','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Properties of shapes','Properties of polygons','TO_BE_VERIFIED',2,
 'What is the sum of the interior angles of a hexagon (6 sides)?','600°','1080°','360°',
 '720°','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Properties of shapes','Circle theorems (Higher)','TO_BE_VERIFIED',2,
 'A triangle is drawn with all three vertices on a circle, and one side of the triangle is a diameter of the circle. What is the angle at the vertex opposite the diameter?','45°','180°',
 '90°','It depends on the triangle','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Properties of shapes','Transformations','TO_BE_VERIFIED',1,
 'A shape is reflected in the x-axis. The point (3, 5) on the original shape maps to which point?','(−3, 5)',
 '(3, −5)','(−3, −5)','(5, 3)','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Perimeter, area, volume','Circumference and area of circle','TO_BE_VERIFIED',2,
 'A circle has a radius of 7 cm. What is its circumference? (Use π ≈ 3.14)','21.98 cm',
 '43.96 cm','153.86 cm','49 cm','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Perimeter, area, volume','Surface area','TO_BE_VERIFIED',2,
 'A cube has a side length of 4 cm. What is its total surface area?','64 cm³','16 cm²',
 '96 cm²','24 cm²','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Angles and geometry','Angles on lines and points','TO_BE_VERIFIED',1,
 'Two angles lie on a straight line. One angle is 65°. What is the other angle?','25°','65°',
 '115°','295°','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Angles and geometry','Parallel lines','TO_BE_VERIFIED',2,
 'Two parallel lines are cut by a transversal. One angle formed is 70°. What is its corresponding angle?','20°','110°',
 '70°','290°','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Angles and geometry','Angles in polygons','TO_BE_VERIFIED',2,
 'A regular pentagon has all interior angles equal. What is the size of each interior angle?','72°','540°',
 '108°','90°','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Angles and geometry','Bearings','TO_BE_VERIFIED',3,
 'The bearing of point B from point A is 130°. What is the bearing of point A from B?','130°','050°','230°',
 '310°','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Constructions and loci','Perpendicular bisector','TO_BE_VERIFIED',2,
 'Which construction gives every point that is exactly the same distance from two given points, A and B?','A circle centred at A','The angle bisector at A',
 'The perpendicular bisector of AB','A straight line through A and B','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Constructions and loci','Angle bisector','TO_BE_VERIFIED',2,
 'A locus of points is equidistant from two straight lines that meet at a point. What construction produces this locus?','A line parallel to one of the lines','The perpendicular bisector of the angle','A circle centred where the lines meet',
 'The angle bisector of the angle between the two lines','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Constructions and loci','Loci','TO_BE_VERIFIED',2,
 'A goat is tied to a post by a rope exactly 5 metres long, in an open field. What shape describes the locus of the furthest points the goat can reach?','A square of side 5 m',
 'A circle of radius 5 m, centred on the post','A straight line 5 m long','A circle of radius 10 m, centred on the post','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Constructions and loci','Constructing a triangle','TO_BE_VERIFIED',1,
 'To construct a triangle from three given side lengths using only a compass and straightedge, which tool is used to mark out each side''s exact length?','A set square, to draw a right angle','A protractor, to measure an angle','A ruler alone, judged by eye',
 'A compass, set to the given length, to draw an arc','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Trigonometry','Pythagoras'' theorem','TO_BE_VERIFIED',1,
 'A right-angled triangle has two shorter sides of 6 cm and 8 cm. What is the length of the hypotenuse?','14 cm',
 '10 cm','100 cm','7 cm','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Trigonometry','SOH CAH TOA','TO_BE_VERIFIED',2,
 'In a right-angled triangle, an angle is 30°, and the hypotenuse is 12 cm. What is the length of the side opposite the angle? (Use sin 30° = 0.5)','0.5 cm','24 cm','12.5 cm',
 '6 cm','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Trigonometry','Sine and cosine rule (Higher)','TO_BE_VERIFIED',3,
 'In a triangle, side a=7 cm, side b=9 cm, and the angle C between them is 60°. Using the cosine rule (c² = a² + b² − 2ab cos C), what is c²?','4','193','130',
 '67','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Vectors','Vector notation','TO_BE_VERIFIED',2,
 'What is the magnitude of the vector (3, 4)?','7',
 '5','25','12','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Probability','Probability scale','TO_BE_VERIFIED',1,
 'A bag contains 4 red balls and 6 blue balls. What is the probability of picking a red ball at random?','6/10','4/6','1/4',
 '2/5','Not sure', 'd',
...
('Mathematics','AQA','GCSE','Higher','Probability','Conditional probability (Higher)','TO_BE_VERIFIED',3,
 'A bag contains 5 red and 3 blue balls. A ball is picked and NOT replaced, then a second ball is picked. What is the probability that both balls are red?','5/8','25/64',
 '5/14','4/7','Not sure', 'c',
...
('Mathematics','AQA','GCSE','Higher','Statistics','Averages and spread','TO_BE_VERIFIED',1,
 'Find the median of this data set: 4, 7, 2, 9, 5','2',
 '5','5.4','9','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Statistics','Scatter graphs','TO_BE_VERIFIED',1,
 'A scatter graph shows height plotted against weight for a group of people, and the points generally rise from bottom-left to top-right. What type of correlation does this show?','Negative correlation',
 'Positive correlation','No correlation','Perfect correlation','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Statistics','Histograms (Higher)','TO_BE_VERIFIED',2,
 'A histogram bar covers the class interval 10–20 (a width of 10) and has a frequency density of 3. What is the frequency for this class?','3',
 '30','13','7','Not sure', 'b',
...
('Mathematics','AQA','GCSE','Higher','Statistics','Cumulative frequency (Higher)','TO_BE_VERIFIED',2,
 'A cumulative frequency table shows that 25 students scored 60 marks or below, and 40 students scored 70 marks or below in total. How many students scored between 60 and 70 marks?','40',
 '15','65','25','Not sure', 'b',
