...
--
-- specification_ref is 'PAPER2_POOL_2026' for every row here (NOT
-- 'TO_BE_VERIFIED', used by the original 68-question bank) deliberately
-- — this is the tag the Paper 2 diagnostic entry point filters on. The
-- original 68 questions ALSO get paper=1/2 backfilled by
-- diagnostic_questions_paper_column.sql (including 32 that land on
-- paper=2, since 8 of the general bank's 17 topics are Paper 2 topics),
-- so 'paper' alone can't distinguish "this dedicated Paper 2 diagnostic's
-- own pool" from "a Paper-2-topic question that's part of the
-- general/shared pool" — specification_ref is what does that, so a
-- student who takes both diagnostics never sees the same question twice.
--
-- source stays 'ai_drafted', same as the original bank — NOT a new
-- value ('ai_drafted_paper2' was tried first and rejected live by
-- diagnostic_questions_source_check, a CHECK constraint that only
-- allows the values already in use; specification_ref carries no such
-- constraint, which is why it's the marker used here instead).
--
...
('Mathematics','AQA','GCSE','Higher','Properties of shapes','Angles in polygons','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Properties of shapes','Circle theorems (Higher)','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Properties of shapes','Congruence and similarity','PAPER2_POOL_2026',3,
...
('Mathematics','AQA','GCSE','Higher','Properties of shapes','Transformations','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Perimeter, area, volume','Area of 2D shapes','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Perimeter, area, volume','Circumference and area of circle','PAPER2_POOL_2026',3,
...
('Mathematics','AQA','GCSE','Higher','Perimeter, area, volume','Volume of 3D shapes','PAPER2_POOL_2026',1,
...
('Mathematics','AQA','GCSE','Higher','Perimeter, area, volume','Surface area','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Angles and geometry','Parallel lines','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Angles and geometry','Angles in polygons','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Angles and geometry','Bearings','PAPER2_POOL_2026',3,
...
('Mathematics','AQA','GCSE','Higher','Angles and geometry','Angles on lines and points','PAPER2_POOL_2026',1,
...
('Mathematics','AQA','GCSE','Higher','Constructions and loci','Angle bisector','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Constructions and loci','Perpendicular bisector','PAPER2_POOL_2026',1,
...
-- Constructions and loci / Angle bisector
('Mathematics','AQA','GCSE','Higher','Constructions and loci','Angle bisector','PAPER2_POOL_2026',1,
...
('Mathematics','AQA','GCSE','Higher','Constructions and loci','Constructing a triangle','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Trigonometry','Pythagoras'' theorem','PAPER2_POOL_2026',1,
...
('Mathematics','AQA','GCSE','Higher','Trigonometry','SOH CAH TOA','PAPER2_POOL_2026',2,
...
-- Trigonometry / SOH CAH TOA
('Mathematics','AQA','GCSE','Higher','Trigonometry','SOH CAH TOA','PAPER2_POOL_2026',3,
...
('Mathematics','AQA','GCSE','Higher','Trigonometry','Exact trig values','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Vectors','Adding and subtracting vectors','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Vectors','Vector notation','PAPER2_POOL_2026',2,
...
-- Vectors / Vector notation
('Mathematics','AQA','GCSE','Higher','Vectors','Vector notation','PAPER2_POOL_2026',1,
...
('Mathematics','AQA','GCSE','Higher','Probability','Tree diagrams','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Probability','Venn diagrams','PAPER2_POOL_2026',2,
...
-- Probability / Venn diagrams
('Mathematics','AQA','GCSE','Higher','Probability','Venn diagrams','PAPER2_POOL_2026',1,
...
('Mathematics','AQA','GCSE','Higher','Statistics','Averages and spread','PAPER2_POOL_2026',1,
...
('Mathematics','AQA','GCSE','Higher','Statistics','Scatter graphs','PAPER2_POOL_2026',1,
...
('Mathematics','AQA','GCSE','Higher','Statistics','Histograms (Higher)','PAPER2_POOL_2026',2,
...
('Mathematics','AQA','GCSE','Higher','Statistics','Cumulative frequency (Higher)','PAPER2_POOL_2026',3,
