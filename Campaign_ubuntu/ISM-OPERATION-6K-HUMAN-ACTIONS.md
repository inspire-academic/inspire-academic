...
- Landing page: **https://staging.inspireacademic.org/programmes/science-mastery/** (or the short link **https://staging.inspireacademic.org/science-mastery** once you've confirmed it) — verify on staging first, then the same paths on `inspireacademic.org` once merged to main.
